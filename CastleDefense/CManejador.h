...
public:
	...
	void Guardar(int saven)
	{
		...
		auto devolverstring = [&](int saven)
		{
			if (saven == 1)
			{
				cadenas.push_back("Slot1generalGame");
				cadenas.push_back("Slot1torretas");
			}
			else
				if (saven == 2)
				{
					cadenas.push_back("Slot2generalGame");
					cadenas.push_back("Slot2torretas");
				}
				else
					if (saven == 3)
					{
						cadenas.push_back("Slot3generalGame");
						cadenas.push_back("Slot3torretas");
					}
		};
